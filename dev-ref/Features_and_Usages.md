...
5.  Sheet bar
      -   
        ...
        ![essentials-feature-addSheet.png](essentials-feature-addSheet.png
        ...
        ![ center](essentials-feature-sheet-contextmenu.png " center")
        Sheet navigation button makes you switch sheets conveniently.

![ center](essentials-feature-sheet-navigation.png " center")
...
center](zss-essential-zkchart.png " 900px | center")
...
![ center](essential-richtexteditor.png " center")
...
![ 550px](essential-edit-comment.png " 550px")
![essential-display-comment.png](essential-display-comment.png
...
center](zss-essentials-feature-zoom150.png " 800px| center")
...
center](zss-essentials-dateFormat.png " center") Regional ones will
...
center](zss-essentials-conditionalFormatting.png " center")
...
![ center](essentials-feature-customSortDialog.png " center")

The sorting result of criteria above: ![
center](essentials-feature-customSort-after.png " center")
...
![ center](essentials-feature-autoFill-select.png " center")

Fill cells by dragging right, left, up, or down. ![
center](essentials-feature-autoFill.png " center")
...
cells. ![ center](essentials-feature-formatCell.png " center")
...
![ center](zss-essentials-feature-protection.png " center")
...
center](zss-essentials-filter-menu.png " center")

Click "Filter"
![zss-essentials-filter-filter-icon.png](zss-essentials-filter-filter-icon.png
...
![zss-essentials-filter-dropdown-icon.png](zss-essentials-filter-dropdown-icon.png
...
![ center](zss-essentials-filter-enable.png " center")

After you select some values click
![zss-essentials-ok.png](zss-essentials-ok.png "zss-essentials-ok.png"),
...
Click "Clear"
![zss-essentials-filter-clear-icon.png](zss-essentials-filter-clear-icon.png
...
![zss-essentials-filter-reapply-icon.png](zss-essentials-filter-reapply-icon.png
...
center](zss-essentials-filterBySearching.png " center")

`since 3.9.0`

ZSS supports **number filter**, **color filter**, **date filter**, and
**text filter**. ![ center](zss-essentials-colorFilter.png " center")

![ center](zss-essentials-dateFilter.png " center")
...
![ center](zss-essentials-validation-dialog.png " center")
...
alert
![zss-essentials-validation-warning-icon.png](zss-essentials-validation-warning-icon.png
...
![zss-essentials-validation-information-icon.png](zss-essentials-validation-information-icon.png
